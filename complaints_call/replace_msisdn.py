...
class Replace_msisdn_in_xml_class:
    ...
    def __init__(self, msisdn):
        self.msisdn = msisdn
        self.filename = 'complaints_call/storage_xml/xml_request_by_msisdn.xml'
...
# ------------ Method which modify msisdn in xml request_by_msisdn file and save it into 'output.xml' file -----------
    def main(self):
        ...
        tree.write('complaints_call/storage_xml/xml_to_send_to_hlr.xml')
        return 'complaints_call/storage_xml/xml_to_send_to_hlr.xml'
